...
// Math.floor faz o número ficar sem casas decimais.
// O igual no parâmetro representa um valor default para caso nada seja inserido.
...
const getUser = (callback) => {
  setTimeout(() => {
    ...
    //Se eu por somento o return, não vai aparecer nada na tela.
  }, delay());
};
