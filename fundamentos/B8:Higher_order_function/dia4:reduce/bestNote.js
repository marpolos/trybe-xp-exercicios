...
console.log(estudantes[0].materias.reduce((acc, materia) => acc.nota > materia.nota? acc : materia));
   const bestMatter = (estudantes) => estudantes.map((estudante) => ({
      name: estudante.nome,
      materia: estudante.materias.reduce((acc, materia) => acc.nota > materia.nota ? acc : materia).nota}));
