...
const checkIfElse = (age) => {
  ...
  const checkTernary2 = (fruit === `maçã`) ? `Essa fruta é vermelha` : ((fruit === `banana`) ? `Esta fruta é amarela` : `Não sei a cor`);
  console.log(checkTernary2);
